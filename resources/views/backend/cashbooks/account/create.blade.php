...
<div class="row">
    <div class="col-md-12 col-sm-12  animation">
        <div class="x_panel">
          <div class="x_title">
            <h2>Add Accounts<small>add a account</small></h2>
          ...
          <div class="x_content">
            <form id="demo-form" action="{{route('accounts.store')}}" method="Post">
              @csrf
              
              <div class="row">
                <div class="col-6 mb-3">
                  <label for="name">Bank Name * :</label>
                  <input type="text" id="name" class="form-control" name="bank_name" value="{{old('bank_name')}}" class="@error('bank_name') is-invalid @enderror">
                  @error('bank_name')
                ...
                <div class="col-6 mb-3">
                  ...
                  <input type="text" id="branch" class="form-control" value="{{old('branch_name')}}" name="branch_name" class="@error('branch_name') is-invalid @enderror">
                  @error('branch_name')
                      <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
                ...
                <div class="col-6 mb-3">
                  ...
                  <input type="number" id="account_number" class="form-control" value="{{old('account_number')}}" name="account_number" class="@error('account_number') is-invalid @enderror">
